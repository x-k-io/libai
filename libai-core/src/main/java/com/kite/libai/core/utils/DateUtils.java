...
public class DateUtils {
    ...
    public static final DateTimeFormatter HOURS_FORMATTER = DatePattern.NORM_HOURS_FORMAT;
    ...
    public static Date plusYears(Date date, int yearsToAdd) {
        return DateUtils.plusAtUtc(date, Period.ofYears(yearsToAdd));
    }
    ...
    public static Date plusMonths(Date date, int monthsToAdd) {
        return DateUtils.plusAtUtc(date, Period.ofMonths(monthsToAdd));
    }
    ...
    public static Date minusYears(Date date, int years) {
        return DateUtils.minusAtUtc(date, Period.ofYears(years));
    }
    ...
    public static Date minusMonths(Date date, int months) {
        return DateUtils.minusAtUtc(date, Period.ofMonths(months));
    }
     ...
     * @return 时间
     */
    public static LocalDateTime parseDateTime(CharSequence text, String[] parsePatterns) {
     ...
     * @return 时间
     */
    public static LocalDateTime parseDateTime(CharSequence text, Locale locale,
     ...
     * @return 时间
     */
    public static LocalDate parseDate(CharSequence text, String[] parsePatterns) {
     ...
     * @return 时间
     */
    public static LocalDate parseDate(CharSequence text, Locale locale,
                                      String[] parsePatterns) {
     ...
     * @return 时间
     */
    public static LocalTime parseTime(CharSequence text, String[] parsePatterns) {
     ...
     * @return 时间
     */
    public static LocalTime parseTime(CharSequence text, Locale locale,
                                      String[] parsePatterns) {
     ...
     * @return 时间
     */
    public static <T> T parse(CharSequence text, Locale locale, String[] parsePatterns,
