...
public class DesUtils {
    ...
    public static String genDesKey() {
        return RandomUtils.random(16, RandomType.ALL);
    }
    ...
    public static String decryptFormHex(String data, String password) {
        if (StringUtils.isBlank(data)) {
            return null;
        }
    ...
    public static String decryptFormBase64(String data, String password) {
        if (StringUtils.isBlank(data)) {
            return null;
        }
