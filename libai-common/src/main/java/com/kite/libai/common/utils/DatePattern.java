...
public interface DatePattern {
     ...
     */
    DateTimeFormatter NORM_DATE_FORMAT =
     ...
     * 标准小时格式：HH
     */
    String NORM_HOURS_PATTERN = "HH";
    /**
     * 标准小时格式 {@link DateTimeFormatter}：HH
     */
    DateTimeFormatter NORM_HOURS_FORMAT =
            DateTimeFormatter.ofPattern(NORM_HOURS_PATTERN).withZone(ZoneId.systemDefault());
     ...
     */
    DateTimeFormatter NORM_TIME_FORMAT =
     ...
     */
    DateTimeFormatter NORM_DATETIME_MINUTE_FORMAT =
            DateTimeFormatter.ofPattern(NORM_DATETIME_MINUTE_PATTERN).withZone(ZoneId.systemDefault());
     ...
     */
    DateTimeFormatter NORM_DATETIME_FORMAT =
     ...
     */
    DateTimeFormatter NORM_DATETIME_MS_FORMAT =
     ...
     */
    DateTimeFormatter CHINESE_DATE_FORMAT =
     ...
     */
    DateTimeFormatter PURE_DATE_FORMAT =
     ...
     */
    DateTimeFormatter HTTP_DATETIME_FORMAT =
            DateTimeFormatter.ofPattern(HTTP_DATETIME_PATTERN, Locale.US).withZone(ZoneId.of("GMT"));
     ...
     */
    DateTimeFormatter UTC_WITH_ZONE_OFFSET_FORMAT =
     ...
     * UTC时间{@link DateTimeFormatter}：yyyy-MM-dd'T'HH:mm:ssZ
     */
    DateTimeFormatter UTC_MS_WITH_ZONE_OFFSET_FORMAT =
