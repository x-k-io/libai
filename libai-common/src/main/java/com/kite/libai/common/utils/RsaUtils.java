...
public class RsaUtils {
    ...
    public static String decryptFromBase64(PrivateKey privateKey,  String base64Data) {
    ...
    public static String decryptByPublicKeyFromBase64(PublicKey publicKey,  String base64Data) {
        if (StringUtils.isBlank(base64Data)) {
            return null;
        }
